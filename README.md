# Permissions-Helper [ ![Download](https://api.bintray.com/packages/andrew-quebe/maven/perms-helper/images/download.svg) ](https://bintray.com/andrew-quebe/maven/perms-helper/_latestVersion)
